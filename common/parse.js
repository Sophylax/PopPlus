...
parse = {
    ...
    bankAccountDetails: function(document) {
        ...
        var interestRate = parseFloat(document.querySelector("#ppm-content > div:nth-child(4) > table > tbody > tr:nth-child(5) > td:nth-child(2)").innerText.replaceAll(',', '').replace('%', '')) / 100;
        return {
            owner: owner,
            bankId: bankId,
